  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100">Pages</h1>
          <p className="text-gray-400 dark:text-zinc-500 text-sm mt-1">{allPages.length} page{allPages.length !== 1 ? 's' : ''}</p>
        </div>
